import player.player as player_
...
class PlayerControler:
    ...
    def register_player(self, ind, last_name, first_name, date_birth, gender, classement):
        ...
        if exist:
            ...
            p = player_.Player(ind, last_name, first_name, date_birth, gender, classement)
    ...
    def load_players(self):
        ...
        for ind, ser_player in enumerate(serialized_players):
            self.players.append(
                player_.Player(ser_player['Ind'], ser_player['Nom'], ser_player['Prenom'],
